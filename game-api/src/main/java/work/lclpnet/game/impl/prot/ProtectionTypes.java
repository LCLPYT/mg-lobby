...
import work.lclpnet.game.impl.prot.scope.ClickEventProtection;
import work.lclpnet.game.impl.prot.scope.EntityBlockProtection;
import work.lclpnet.game.impl.prot.scope.EntityDamageSourceProtection;
import work.lclpnet.game.impl.prot.scope.EntityItemEntityProtection;
import work.lclpnet.game.impl.prot.scope.GenericProtection;
import work.lclpnet.game.impl.prot.scope.ItemScatterProtection;
import work.lclpnet.game.impl.prot.scope.PlayerEntityProtection;
import work.lclpnet.game.impl.prot.scope.PlayerGeneric2Protection;
import work.lclpnet.game.impl.prot.scope.PlayerGenericProtection;
import work.lclpnet.game.impl.prot.scope.PlayerIntBoolProtection;
import work.lclpnet.game.impl.prot.scope.PlayerIntProtection;
import work.lclpnet.game.impl.prot.scope.PlayerItemEntityProtection;
import work.lclpnet.game.impl.prot.scope.PlayerItemStackProtection;
import work.lclpnet.game.impl.prot.scope.PlayerProtection;
import work.lclpnet.game.impl.prot.scope.ProjectileHitProtection;
import work.lclpnet.game.impl.prot.scope.WorldBlockItemStackProtection;
import work.lclpnet.game.impl.prot.scope.WorldBlockProtection;
