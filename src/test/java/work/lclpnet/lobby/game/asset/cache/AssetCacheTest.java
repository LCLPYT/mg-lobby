...
class AssetCacheTest {
    ...
    void getCachedReturnsEmptyWhenEmptyPathOrInvalid() {
        CacheIndex index = mock(CacheIndex.class);
        AssetCache cache = new AssetCache(index, Path.of("root"), logger);
    ...
    void cacheWritesFileCorrectly() throws IOException {
        ...
        AssetCache cache = new AssetCache(index, tempDir, logger);
    ...
    void cacheEmptyPathThrows() {
        AssetCache cache = new AssetCache(mock(CacheIndex.class), Path.of("root"), logger);
