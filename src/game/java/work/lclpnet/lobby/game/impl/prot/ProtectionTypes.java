...
public class ProtectionTypes {
    ...
    public static final ProtectionType<PlayerGenericScope<UseOnContext>> USE_ITEM_ON_BLOCK;
    ...
    public static final ProtectionType<GenericScope<ServerExplosion>> EXPLOSION;
    ...
    public static final ProtectionType<PlayerEntityScope<ItemFrame>> ITEM_FRAME_SET_ITEM;
    public static final ProtectionType<PlayerEntityScope<ItemFrame>> ITEM_FRAME_REMOVE_ITEM;
    public static final ProtectionType<PlayerEntityScope<ItemFrame>> ITEM_FRAME_ROTATE_ITEM;
    public static final ProtectionType<PlayerEntityScope<ArmorStand>> ARMOR_STAND_MANIPULATE;
    ...
    public static final ProtectionType<PlayerEntityScope<LeashFenceKnotEntity>> LEASH_KNOT_TAKE;
    ...
    public static final ProtectionType<PlayerEntityScope<Projectile>> PICKUP_PROJECTILE;
