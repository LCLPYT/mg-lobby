...
public class TranslatedBossBar extends ServerBossBar implements CustomBossBar {
    ...
    private final BossBarHandler handler;
    ...
    public TranslatedBossBar(BossBarHandler handler, Identifier identifier, TranslationService translations, String translationKey, Object[] args) {
        this(handler, identifier, translations, "en_us", translationKey, args);
    }

    public TranslatedBossBar(BossBarHandler handler, Identifier identifier, TranslationService translations, String defaultLanguage, String translationKey, Object[] args) {
        super(null, BossBar.Color.WHITE, Style.PROGRESS);
        ...
        handler.removePlayersOnQuit(this);
    }
    ...
    private CommandBossBar createBossBar(Identifier id, Text title) {
        CommandBossBar bossBar = handler.createBossBar(id, title);
