...
public class Geyser {
    ...
    private void erupt() {
        ...
        box = new Box(
                ...
                pos.x + 2, pos.y + eruptionStrength * 20, pos.z + 2
        );
    ...
    private void erupting() {
        ...
        world.spawnParticles(ParticleTypes.CLOUD, x, y, z, 10, 0.25, box.getYLength(), 0.25, 0.15);
        world.spawnParticles(ParticleTypes.CLOUD, x, y, z, 5, 1, 0.1, 1, 0.2);
