...
class LobbyTranslations {
    ...
    public static Result load(Logger logger) {
        ...
        var langLoader = new UrlLanguageLoader(locations, List.of("assets/" + LobbyMod.ID + "/lang/"), logger);
